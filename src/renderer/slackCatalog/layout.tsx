 ...
 * `Column`/`Row` inside a block box carrying {@link SLACK_LAYOUT_CLAMP_CLASS}
 ...
 * (MessageList/SearchResultList/ChannelList) finally wrap. Purely a width clamp; all SDK
...
import { SLACK_LAYOUT_CLAMP_CLASS } from './logic'
...
export function Column(props: React.ComponentProps<typeof SdkColumn>): React.JSX.Element {
  return (
    <div className={SLACK_LAYOUT_CLAMP_CLASS}>
      <SdkColumn {...props} />
    </div>
  )
}
